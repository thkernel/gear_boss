...
class InsurersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create insurer" do
    assert_difference('Insurer.count') do
      post insurers_url, params: { insurer: { uid: @insurer.uid, user_id: @insurer.user_id } }
    end
  ...
  test "should update insurer" do
    patch insurer_url(@insurer), params: { insurer: { uid: @insurer.uid, user_id: @insurer.user_id } }
