...
class RentalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rental" do
    assert_difference('Rental.count') do
      post rentals_url, params: { rental: { booking_id: @rental.booking_id, uid: @rental.uid, user_id: @rental.user_id } }
    end
  ...
  test "should update rental" do
    patch rental_url(@rental), params: { rental: { booking_id: @rental.booking_id, uid: @rental.uid, user_id: @rental.user_id } }
