...
class InvoiceItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invoice_item" do
    assert_difference('InvoiceItem.count') do
      post invoice_items_url, params: { invoice_item: { invoice_id: @invoice_item.invoice_id, uid: @invoice_item.uid } }
    end
  ...
  test "should update invoice_item" do
    patch invoice_item_url(@invoice_item), params: { invoice_item: { invoice_id: @invoice_item.invoice_id, uid: @invoice_item.uid } }
