...
class ExpenseTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create expense_type" do
    assert_difference('ExpenseType.count') do
      post expense_types_url, params: { expense_type: { description: @expense_type.description, name: @expense_type.name, status: @expense_type.status, uid: @expense_type.uid, user_id: @expense_type.user_id } }
    end
  ...
  test "should update expense_type" do
    patch expense_type_url(@expense_type), params: { expense_type: { description: @expense_type.description, name: @expense_type.name, status: @expense_type.status, uid: @expense_type.uid, user_id: @expense_type.user_id } }
